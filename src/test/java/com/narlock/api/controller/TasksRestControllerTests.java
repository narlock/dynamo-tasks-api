...
public class TasksRestControllerTests {
    ...
    public void testGetTasks() throws Exception {
        ...
        mockMvc.perform(get("/tasks")
                ...
                .andExpect(jsonPath("$.tasks[0].description").value("Finalize and submit the project documentation by the end of the week."))
                ...
                .andExpect(jsonPath("$.tasks[1].description").value("Buy groceries for the week, including fruits, vegetables, and dairy products."))
